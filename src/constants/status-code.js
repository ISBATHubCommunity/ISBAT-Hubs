 ...
 * outcome of processing the request. It is intended for cases where another process
 ...
 */
 ...
 /**
  * This response would be sent when the requested content has been permenantly deleted from
  * server, with no forwarding address. Clients are expected to remove their caches and links
  * to the resource. The HTTP specification intends this status code to be used for "limited-time,
 ...
 /**
    ...
    * complete the request. This condition is considered to be temporary. If the request which
 ...
 /**
  * The server rejected the request because the Content-Length header field is not defined and the
  * server requires it.
  */
 ...
 /**
  * The request has more than one possible responses. User-agent or user should choose one
  * of them. There is no standardized way to choose one of the responses.
  */
  ...
  *
  * This response code is reserved for future use. Initial aim for creating this code was using it
  ...
  * before the recovery of the service. The webmaster must also take care about the caching-related
  ...
  * protocol the server is switching too.
  */
 export const SWITCHING_PROTOCOLS = 101;
 
 /**
  * Server sent this response to directing client to get requested resource to another URI with
  * same method that used prior request. This has the same semantic than the 302 Found HTTP response
 ...
 /**
  * Defined in the specification of HTTP/2 to indicate that a server is not able to produce a
  * response for the combination of scheme and authority that are included in the request URI.
  */
